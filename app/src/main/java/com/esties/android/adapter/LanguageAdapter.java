...
public class LanguageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LanguageAdapter(@NonNull Context context, List<HomeScreenMenuModel> values, ItemListener mListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.language_data_layout, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            menu_item_name = view.findViewById(R.id.language);
