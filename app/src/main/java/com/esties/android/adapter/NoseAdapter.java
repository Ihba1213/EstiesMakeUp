...
public class NoseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context mContext;
    public List<NoseModel.NoseDataModel> mValues;
    public ItemListener mlistener;
    int selectedPosition = -1;
    public NoseAdapter(@NonNull Context context, List<NoseModel.NoseDataModel> values, ItemListener mListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mlistener != null) {
                    mlistener.onNoseSelected(mValues.get(position));
                }

            }
        });
        ((MyViewHolder) holder).setData((NoseModel.NoseDataModel) mValues.get(position));
    }
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(NoseModel.NoseDataModel item) {
            this.item = item;
            Glide.with(mContext)
    ...
    public interface ItemListener {
        void onNoseSelected( NoseModel.NoseDataModel item);
    }
}
