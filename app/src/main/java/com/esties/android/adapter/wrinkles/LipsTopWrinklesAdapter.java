...
public class LipsTopWrinklesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context mContext;
    public List<LipsTopWrinkle> mValues;
    public ItemListener mlistener;
    int selectedPosition = -1;
    public LipsTopWrinklesAdapter(@NonNull Context context, List<LipsTopWrinkle> values, ItemListener mListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mlistener != null) {
                    mlistener.onLipsTopWrinkles(mValues.get(position));
                }

            }
        });
        ((MyViewHolder) holder).setData((LipsTopWrinkle) mValues.get(position));
    }
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(LipsTopWrinkle item) {
            this.item = item;
            Glide.with(mContext)
    ...
    public interface ItemListener {
        void onLipsTopWrinkles(LipsTopWrinkle lipsTopWrinkle);
    }
}
